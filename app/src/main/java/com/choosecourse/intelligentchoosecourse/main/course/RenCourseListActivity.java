 ...
 */
public class RenCourseListActivity extends Activity {
	private Button back;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		//构造Adapter
		CourseAdapter adapter = new CourseAdapter(RenCourseListActivity.this, courseList);
		...
		submitButton.setOnClickListener(new View.OnClickListener() {
			                                ...
			                                public void onClick(View view) {
				                                AlertDialog alertDialog = new AlertDialog.Builder(RenCourseListActivity.this).create();
								                                ...
								                                if (courses.size() > 0) {
									                                for (Course course : courses) {
										                                ...
										                                if (course.getCn().equals(list.name)) {
											                                ...
											                                Log.d("你好", "插入成功");
											                                Toast.makeText(RenCourseListActivity.this, "提交成功", Toast.LENGTH_SHORT).show();
										                                }
